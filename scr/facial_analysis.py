...
class FacialImageProcessing:
    ...
    def __init__(self, print_stat=False, minsize = 32):
        ...
        # models_path,_ = os.path.split(os.path.realpath('/home/milla/test_emotions/models/'))
        # print(models_path)
        ...
        with tf.Graph().as_default() as full_graph:
            for model_file in model_files:
                ...
                # tf.import_graph_def(FacialImageProcessing.load_graph_def('/home/milla/test_emotions/models/pretrained_faces/mtcnn.pb'), name=model_files[model_file])
